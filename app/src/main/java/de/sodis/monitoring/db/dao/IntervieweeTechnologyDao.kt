...
interface IntervieweeTechnologyDao {
    ...
    @Query("SELECT IntervieweeTechnology.stateKnowledge,IntervieweeTechnology.stateTechnology, Technology.name FROM IntervieweeTechnology JOIN Technology ON IntervieweeTechnology.technologyId=Technology.id WHERE intervieweeId=:intervieweeId")
